...
from .base import ClientConnectorServicesServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ClientConnectorServicesServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_client_connector_service(self, request: client_connector_services_service.CreateClientConnectorServiceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[client_connector_services_service.CreateClientConnectorServiceRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_client_connector_service(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_delete_client_connector_service(self, request: client_connector_services_service.DeleteClientConnectorServiceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[client_connector_services_service.DeleteClientConnectorServiceRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_delete_client_connector_service(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_get_client_connector_service(self, request: client_connector_services_service.GetClientConnectorServiceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[client_connector_services_service.GetClientConnectorServiceRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_client_connector_service(self, response: client_connector_services_service.ClientConnectorService) -> client_connector_services_service.ClientConnectorService:
        ...
        """
        return response
    def pre_list_client_connector_services(self, request: client_connector_services_service.ListClientConnectorServicesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[client_connector_services_service.ListClientConnectorServicesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_client_connector_services(self, response: client_connector_services_service.ListClientConnectorServicesResponse) -> client_connector_services_service.ListClientConnectorServicesResponse:
        ...
        """
        return response
    def pre_update_client_connector_service(self, request: client_connector_services_service.UpdateClientConnectorServiceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[client_connector_services_service.UpdateClientConnectorServiceRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_update_client_connector_service(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
...
class ClientConnectorServicesServiceRestTransport(ClientConnectorServicesServiceTransport):
    """REST backend transport for ClientConnectorServicesService.
    ...
    def __init__(self, *,
        ...
        self._interceptor = interceptor or ClientConnectorServicesServiceRestInterceptor()
    ...
    class _CreateClientConnectorService(ClientConnectorServicesServiceRestStub):
        def __hash__(self):
            return hash("CreateClientConnectorService")
        ...
        service method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{parent=projects/*/locations/*}/clientConnectorServices',
                'body': 'client_connector_service',
            },
            ]
            request, metadata = self._interceptor.pre_create_client_connector_service(request, metadata)
    ...
    class _DeleteClientConnectorService(ClientConnectorServicesServiceRestStub):
        def __hash__(self):
            return hash("DeleteClientConnectorService")
        ...
        service method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1/{name=projects/*/locations/*/clientConnectorServices/*}',
            },
            ]
            request, metadata = self._interceptor.pre_delete_client_connector_service(request, metadata)
    ...
    class _GetClientConnectorService(ClientConnectorServicesServiceRestStub):
        def __hash__(self):
            return hash("GetClientConnectorService")
        ...
        service method over HTTP.
            ...
            request, metadata = self._interceptor.pre_get_client_connector_service(request, metadata)
    ...
    class _ListClientConnectorServices(ClientConnectorServicesServiceRestStub):
        def __hash__(self):
            return hash("ListClientConnectorServices")
        ...
        services method over HTTP.
            ...
            request, metadata = self._interceptor.pre_list_client_connector_services(request, metadata)
            ...
            # Return the response
            resp = client_connector_services_service.ListClientConnectorServicesResponse()
            pb_resp = client_connector_services_service.ListClientConnectorServicesResponse.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)
            resp = self._interceptor.post_list_client_connector_services(resp)
            return resp

    class _UpdateClientConnectorService(ClientConnectorServicesServiceRestStub):
        def __hash__(self):
            return hash("UpdateClientConnectorService")
        ...
        service method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1/{client_connector_service.name=projects/*/locations/*/clientConnectorServices/*}',
                'body': 'client_connector_service',
            },
            ]
            request, metadata = self._interceptor.pre_update_client_connector_service(request, metadata)
    ...
    @property
    def create_client_connector_service(self) -> Callable[
    ...
    @property
    def delete_client_connector_service(self) -> Callable[
    ...
    @property
    def get_client_connector_service(self) -> Callable[
    ...
    @property
    def list_client_connector_services(self) -> Callable[
    ...
    @property
    def update_client_connector_service(self) -> Callable[
    ...
    class _GetLocation(ClientConnectorServicesServiceRestStub):
        def __call__(self,
    ...
    class _ListLocations(ClientConnectorServicesServiceRestStub):
        def __call__(self,
    ...
    class _GetIamPolicy(ClientConnectorServicesServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _SetIamPolicy(ClientConnectorServicesServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _TestIamPermissions(ClientConnectorServicesServiceRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _CancelOperation(ClientConnectorServicesServiceRestStub):
        def __call__(self,
    ...
    class _DeleteOperation(ClientConnectorServicesServiceRestStub):
        def __call__(self,
    ...
    class _GetOperation(ClientConnectorServicesServiceRestStub):
        def __call__(self,
    ...
    class _ListOperations(ClientConnectorServicesServiceRestStub):
        def __call__(self,
