...
class ClientConnectorServicesServiceGrpcTransport(ClientConnectorServicesServiceTransport):
    ...
    def list_client_connector_services(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListClientConnectorServicesRequest],
        ...
        if 'list_client_connector_services' not in self._stubs:
            self._stubs['list_client_connector_services'] = self.grpc_channel.unary_unary(
    ...
    def get_client_connector_service(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetClientConnectorServiceRequest],
        ...
        if 'get_client_connector_service' not in self._stubs:
            self._stubs['get_client_connector_service'] = self.grpc_channel.unary_unary(
    ...
    def create_client_connector_service(self) -> Callable[
        ...
        Creates a new ClientConnectorService in a given
        project and location.

        Returns:
            Callable[[~.CreateClientConnectorServiceRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if 'create_client_connector_service' not in self._stubs:
            self._stubs['create_client_connector_service'] = self.grpc_channel.unary_unary(
    ...
    def update_client_connector_service(self) -> Callable[
        ...
        Returns:
            Callable[[~.UpdateClientConnectorServiceRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if 'update_client_connector_service' not in self._stubs:
            self._stubs['update_client_connector_service'] = self.grpc_channel.unary_unary(
    ...
    def delete_client_connector_service(self) -> Callable[
        ...
        Returns:
            Callable[[~.DeleteClientConnectorServiceRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        if 'delete_client_connector_service' not in self._stubs:
            self._stubs['delete_client_connector_service'] = self.grpc_channel.unary_unary(
