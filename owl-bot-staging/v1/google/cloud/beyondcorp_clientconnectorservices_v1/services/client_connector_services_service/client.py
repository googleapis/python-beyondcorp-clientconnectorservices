...
from .transports.base import ClientConnectorServicesServiceTransport, DEFAULT_CLIENT_INFO
...
class ClientConnectorServicesServiceClientMeta(type):
    """Metaclass for the ClientConnectorServicesService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ClientConnectorServicesServiceTransport]]
...
class ClientConnectorServicesServiceClient(metaclass=ClientConnectorServicesServiceClientMeta):
    """API Overview
    ------------
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ClientConnectorServicesServiceClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> ClientConnectorServicesServiceTransport:
        """Returns the transport used by the client instance.

        Returns:
            ClientConnectorServicesServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def client_connector_service_path(project: str,location: str,client_connector_service: str,) -> str:
        """Returns a fully-qualified client_connector_service string."""
        return "projects/{project}/locations/{location}/clientConnectorServices/{client_connector_service}".format(project=project, location=location, client_connector_service=client_connector_service, )

    @staticmethod
    def parse_client_connector_service_path(path: str) -> Dict[str,str]:
        """Parses a client_connector_service path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clientConnectorServices/(?P<client_connector_service>.+?)$", path)
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, ClientConnectorServicesServiceTransport):
            # transport is a ClientConnectorServicesServiceTransport instance.
    ...
    def list_client_connector_services(self,
            request: Union[client_connector_services_service.ListClientConnectorServicesRequest, dict] = None,
            *,
            parent: str = None,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_client_connector_services]
        ...
        response = pagers.ListClientConnectorServicesPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def get_client_connector_service(self,
            request: Union[client_connector_services_service.GetClientConnectorServiceRequest, dict] = None,
            *,
            name: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        Returns:
            google.cloud.beyondcorp_clientconnectorservices_v1.types.ClientConnectorService:
                Message describing
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_client_connector_service]
    ...
    def create_client_connector_service(self,
            request: Union[client_connector_services_service.CreateClientConnectorServiceRequest, dict] = None,
            *,
            parent: str = None,
        ...
        Args:
            ...
            client_connector_service (google.cloud.beyondcorp_clientconnectorservices_v1.types.ClientConnectorService):
                ...
                This corresponds to the ``client_connector_service`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            client_connector_service_id (str):
                ...
                This corresponds to the ``client_connector_service_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.beyondcorp_clientconnectorservices_v1.types.ClientConnectorService`
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, client_connector_service, client_connector_service_id])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, client_connector_services_service.CreateClientConnectorServiceRequest):
            ...
            if parent is not None:
                request.parent = parent
            if client_connector_service is not None:
                request.client_connector_service = client_connector_service
            if client_connector_service_id is not None:
                request.client_connector_service_id = client_connector_service_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_client_connector_service]
        ...
        response = operation.from_gapic(
            ...
            client_connector_services_service.ClientConnectorService,
            metadata_type=client_connector_services_service.ClientConnectorServiceOperationMetadata,
        )

        # Done; return the response.
        return response

    def update_client_connector_service(self,
            request: Union[client_connector_services_service.UpdateClientConnectorServiceRequest, dict] = None,
            *,
            client_connector_service: client_connector_services_service.ClientConnectorService = None,
        ...
        .. code-block:: python
            ...
            def sample_update_client_connector_service():
                ...
                request = beyondcorp_clientconnectorservices_v1.UpdateClientConnectorServiceRequest(
                    client_connector_service=client_connector_service,
                )
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                ...
                overwritten in the ClientConnectorService resource by
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_client_connector_service]

         # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("client_connector_service.name", request.client_connector_service.name),
            )),
        )
    ...
    def delete_client_connector_service(self,
            request: Union[client_connector_services_service.DeleteClientConnectorServiceRequest, dict] = None,
            *,
            name: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        .. code-block:: python
            ...
            def sample_delete_client_connector_service():
                ...
                # Initialize request argument(s)
                request = beyondcorp_clientconnectorservices_v1.DeleteClientConnectorServiceRequest(
                    name="name_value",
                )
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_client_connector_service]
