...
from google.cloud.beyondcorp_clientconnectorservices_v1.services.client_connector_services_service import ClientConnectorServicesServiceAsyncClient
from google.cloud.beyondcorp_clientconnectorservices_v1.services.client_connector_services_service import ClientConnectorServicesServiceClient
from google.cloud.beyondcorp_clientconnectorservices_v1.services.client_connector_services_service import pagers
from google.cloud.beyondcorp_clientconnectorservices_v1.services.client_connector_services_service import transports
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (ClientConnectorServicesServiceClient, transports.ClientConnectorServicesServiceGrpcTransport, "grpc"),
    (ClientConnectorServicesServiceAsyncClient, transports.ClientConnectorServicesServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (ClientConnectorServicesServiceClient, transports.ClientConnectorServicesServiceRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (ClientConnectorServicesServiceClient, transports.ClientConnectorServicesServiceGrpcTransport, "grpc", "true"),
    (ClientConnectorServicesServiceAsyncClient, transports.ClientConnectorServicesServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (ClientConnectorServicesServiceClient, transports.ClientConnectorServicesServiceGrpcTransport, "grpc", "false"),
    (ClientConnectorServicesServiceAsyncClient, transports.ClientConnectorServicesServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (ClientConnectorServicesServiceClient, transports.ClientConnectorServicesServiceRestTransport, "rest", "true"),
    (ClientConnectorServicesServiceClient, transports.ClientConnectorServicesServiceRestTransport, "rest", "false"),
])
@mock.patch.object(ClientConnectorServicesServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ClientConnectorServicesServiceClient))
@mock.patch.object(ClientConnectorServicesServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ClientConnectorServicesServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ClientConnectorServicesServiceClient, transports.ClientConnectorServicesServiceGrpcTransport, "grpc", grpc_helpers),
    (ClientConnectorServicesServiceAsyncClient, transports.ClientConnectorServicesServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (ClientConnectorServicesServiceClient, transports.ClientConnectorServicesServiceRestTransport, "rest", None),
])
...
def test_list_client_connector_services_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, client_connector_services_service.ClientConnectorService)
                   for i in results)
...
async def test_list_client_connector_services_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_client_connector_services(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_client_connector_service(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_client_connector_service),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_client_connector_service(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_client_connector_service),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_client_connector_service_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_client_connector_service(
            parent='parent_value',
            client_connector_service=client_connector_services_service.ClientConnectorService(name='name_value'),
...
def test_update_client_connector_service(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_client_connector_service),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_client_connector_service(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_client_connector_service),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_client_connector_services_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = client_connector_services_service.ListClientConnectorServicesResponse.pb(return_value)
...
def test_list_client_connector_services_rest_interceptors(null_interceptor):
    transport = transports.ClientConnectorServicesServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ClientConnectorServicesServiceRestInterceptor(),
        )
    client = ClientConnectorServicesServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "post_list_client_connector_services") as post, \
         mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "pre_list_client_connector_services") as pre:
...
def test_get_client_connector_service_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = client_connector_services_service.ClientConnectorService.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "post_get_client_connector_service") as post, \
         mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "pre_get_client_connector_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "post_create_client_connector_service") as post, \
         mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "pre_create_client_connector_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "post_update_client_connector_service") as post, \
         mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "pre_update_client_connector_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "post_delete_client_connector_service") as post, \
         mock.patch.object(transports.ClientConnectorServicesServiceRestInterceptor, "pre_delete_client_connector_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_transport_kind(transport_name):
    transport = ClientConnectorServicesServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (transports.ClientConnectorServicesServiceGrpcAsyncIOTransport, grpc_helpers_async)
    ],
)
...
def test_client_connector_services_service_host_no_port(transport_name):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='beyondcorp.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'beyondcorp.googleapis.com:443'
...
def test_client_connector_services_service_host_with_port(transport_name):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='beyondcorp.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
@pytest.mark.parametrize("client_class,transport_class", [
    (ClientConnectorServicesServiceClient, transports.ClientConnectorServicesServiceGrpcTransport),
    (ClientConnectorServicesServiceAsyncClient, transports.ClientConnectorServicesServiceGrpcAsyncIOTransport),
])
