...
description = "Google Cloud Beyondcorp Clientconnectorservices API client library"

version = {}
with open(os.path.join(package_root, 'google/cloud/beyondcorp_clientconnectorservices/gapic_version.py')) as fp:
