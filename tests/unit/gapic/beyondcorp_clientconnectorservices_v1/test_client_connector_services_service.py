...
def test__get_default_mtls_endpoint():
    ...
    assert (
        ClientConnectorServicesServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        ClientConnectorServicesServiceClient._get_default_mtls_endpoint(
            api_mtls_endpoint
        )
        == api_mtls_endpoint
    )
    ...
    assert (
        ClientConnectorServicesServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
...
@pytest.mark.parametrize(
    ...
    [
        (ClientConnectorServicesServiceClient, "grpc"),
        (ClientConnectorServicesServiceAsyncClient, "grpc_asyncio"),
        (ClientConnectorServicesServiceClient, "rest"),
    ],
)
def test_client_connector_services_service_client_from_service_account_info(
    client_class, transport_name
):
    ...
    with mock.patch.object(
        ...
        assert client.transport._host == (
            "beyondcorp.googleapis.com:443"
            if transport_name in ["grpc", "grpc_asyncio"]
            else "https://beyondcorp.googleapis.com"
        )
...
@pytest.mark.parametrize(
    ...
    [
        (transports.ClientConnectorServicesServiceGrpcTransport, "grpc"),
        (transports.ClientConnectorServicesServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (transports.ClientConnectorServicesServiceRestTransport, "rest"),
    ],
)
def test_client_connector_services_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_client_connector_services_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_client_connector_services_service_client_get_transport_class():
    ...
    available_transports = [
        ...
        transports.ClientConnectorServicesServiceRestTransport,
    ]
...
@mock.patch.object(
    ClientConnectorServicesServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(ClientConnectorServicesServiceClient),
)
@mock.patch.object(
    ClientConnectorServicesServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(ClientConnectorServicesServiceAsyncClient),
)
def test_client_connector_services_service_client_client_options(
    client_class, transport_class, transport_name
):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(
        ClientConnectorServicesServiceClient, "get_transport_class"
    ) as gtc:
...
def test_client_connector_services_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@pytest.mark.parametrize(
    "client_class",
    [ClientConnectorServicesServiceClient, ClientConnectorServicesServiceAsyncClient],
)
@mock.patch.object(
    ClientConnectorServicesServiceClient,
    "DEFAULT_ENDPOINT",
...
def test_client_connector_services_service_client_get_mtls_endpoint_and_cert_source(
    client_class,
):
...
def test_client_connector_services_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_client_connector_services_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_client_connector_services_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.beyondcorp_clientconnectorservices_v1.services.client_connector_services_service.transports.ClientConnectorServicesServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_client_connector_services_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
    ...
    with mock.patch.object(
        ...
        create_channel.assert_called_with(
            ...
            scopes=None,
            default_host="beyondcorp.googleapis.com",
...
def test_list_client_connector_services(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        type(client.transport.list_client_connector_services), "__call__"
    ) as call:
...
@pytest.mark.asyncio
async def test_list_client_connector_services_async(
    transport: str = "grpc_asyncio",
    request_type=client_connector_services_service.ListClientConnectorServicesRequest,
):
...
async def test_list_client_connector_services_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_client_connector_services(
            parent="parent_value",
        )
...
async def test_list_client_connector_services_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_client_connector_services(
            client_connector_services_service.ListClientConnectorServicesRequest(),
            parent="parent_value",
        )
...
def test_list_client_connector_services_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(
            isinstance(i, client_connector_services_service.ClientConnectorService)
            for i in results
        )
...
async def test_list_client_connector_services_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_client_connector_services),
        "__call__",
        ...
        async_pager = await client.list_client_connector_services(
            request={},
        )
...
def test_get_client_connector_service(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.get_client_connector_service), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = client_connector_services_service.ClientConnectorService(
            name="name_value",
            display_name="display_name_value",
            state=client_connector_services_service.ClientConnectorService.State.CREATING,
        )
    ...
    assert (
        response.state
        == client_connector_services_service.ClientConnectorService.State.CREATING
    )
...
@pytest.mark.asyncio
async def test_get_client_connector_service_async(
    transport: str = "grpc_asyncio",
...
async def test_get_client_connector_service_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_client_connector_service(
            client_connector_services_service.GetClientConnectorServiceRequest(),
            name="name_value",
        )
...
def test_create_client_connector_service(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.create_client_connector_service), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_client_connector_service_async(
    transport: str = "grpc_asyncio",
    request_type=client_connector_services_service.CreateClientConnectorServiceRequest,
):
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_client_connector_service_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_client_connector_service(
            parent="parent_value",
            client_connector_service=client_connector_services_service.ClientConnectorService(
                name="name_value"
            ),
        ...
        mock_val = client_connector_services_service.ClientConnectorService(
            name="name_value"
        )
        assert arg == mock_val
...
async def test_create_client_connector_service_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.create_client_connector_service(
            parent="parent_value",
            client_connector_service=client_connector_services_service.ClientConnectorService(
                name="name_value"
            ),
...
async def test_create_client_connector_service_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_client_connector_service(
            client_connector_services_service.CreateClientConnectorServiceRequest(),
            parent="parent_value",
            client_connector_service=client_connector_services_service.ClientConnectorService(
                name="name_value"
...
def test_update_client_connector_service(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.update_client_connector_service), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
@pytest.mark.asyncio
async def test_update_client_connector_service_async(
    transport: str = "grpc_asyncio",
    request_type=client_connector_services_service.UpdateClientConnectorServiceRequest,
):
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
async def test_update_client_connector_service_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.update_client_connector_service(
            client_connector_service=client_connector_services_service.ClientConnectorService(
                name="name_value"
            ),
            update_mask=field_mask_pb2.FieldMask(paths=["paths_value"]),
...
async def test_update_client_connector_service_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.update_client_connector_service(
            client_connector_services_service.UpdateClientConnectorServiceRequest(),
            client_connector_service=client_connector_services_service.ClientConnectorService(
                name="name_value"
            ),
...
def test_delete_client_connector_service(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.delete_client_connector_service), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
@pytest.mark.asyncio
async def test_delete_client_connector_service_async(
    transport: str = "grpc_asyncio",
    request_type=client_connector_services_service.DeleteClientConnectorServiceRequest,
):
    client = ClientConnectorServicesServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
async def test_delete_client_connector_service_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_client_connector_service(
            name="name_value",
        )
...
async def test_delete_client_connector_service_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_client_connector_service(
            client_connector_services_service.DeleteClientConnectorServiceRequest(),
            name="name_value",
        )
...
def test_list_client_connector_services_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        pb_return_value = (
            client_connector_services_service.ListClientConnectorServicesResponse.pb(
                return_value
            )
        )
...
def test_list_client_connector_services_rest_required_fields(
    request_type=client_connector_services_service.ListClientConnectorServicesRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_client_connector_services._get_unset_required_fields(jsonified_request)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            pb_return_value = client_connector_services_service.ListClientConnectorServicesResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_client_connector_services_rest_unset_required_fields():
    transport = transports.ClientConnectorServicesServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )
...
def test_list_client_connector_services_rest_interceptors(null_interceptor):
    transport = transports.ClientConnectorServicesServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.ClientConnectorServicesServiceRestInterceptor(),
    )
    ...
    with mock.patch.object(
        ...
        "post_list_client_connector_services",
    ) as post, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor,
        "pre_list_client_connector_services",
    ) as pre:
        ...
        req.return_value._content = client_connector_services_service.ListClientConnectorServicesResponse.to_json(
            client_connector_services_service.ListClientConnectorServicesResponse()
        )
...
def test_list_client_connector_services_rest_bad_request(
    transport: str = "rest",
    request_type=client_connector_services_service.ListClientConnectorServicesRequest,
):
    client = ClientConnectorServicesServiceClient(
...
def test_list_client_connector_services_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/clientConnectorServices"
...
def test_list_client_connector_services_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            client_connector_services_service.ListClientConnectorServicesResponse.to_json(
                x
            )
            for x in response
        )
        ...
        pages = list(
            client.list_client_connector_services(request=sample_request).pages
        )
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_get_client_connector_service_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {
        "name": "projects/sample1/locations/sample2/clientConnectorServices/sample3"
    }
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = client_connector_services_service.ClientConnectorService.pb(
            return_value
        )
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_client_connector_service_rest_required_fields(
    request_type=client_connector_services_service.GetClientConnectorServiceRequest,
):
    transport_class = transports.ClientConnectorServicesServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_client_connector_service._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            pb_return_value = (
                client_connector_services_service.ClientConnectorService.pb(
                    return_value
                )
            )
            json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ClientConnectorServicesServiceRestInterceptor,
        "post_get_client_connector_service",
    ) as post, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor,
        "pre_get_client_connector_service",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = (
        ...
        req.return_value._content = (
            client_connector_services_service.ClientConnectorService.to_json(
                client_connector_services_service.ClientConnectorService()
            )
        )
...
def test_get_client_connector_service_rest_bad_request(
    transport: str = "rest",
    request_type=client_connector_services_service.GetClientConnectorServiceRequest,
):
    client = ClientConnectorServicesServiceClient(
...
def test_get_client_connector_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/clientConnectorServices/*}"
            % client.transport._host,
            args[1],
        )
    ...
    request_init["client_connector_service"] = {
        ...
        "ingress": {
            "config": {
                ...
                "destination_routes": [
                    {"address": "address_value", "netmask": "netmask_value"}
                ],
            }
        },
        "egress": {"peered_vpc": {"network_vpc": "network_vpc_value"}},
        "state": 1,
    }
    request = request_type(**request_init)
...
def test_create_client_connector_service_rest_required_fields(
    request_type=client_connector_services_service.CreateClientConnectorServiceRequest,
):
    transport_class = transports.ClientConnectorServicesServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_client_connector_service._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ClientConnectorServicesServiceRestInterceptor,
        "post_create_client_connector_service",
    ) as post, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor,
        "pre_create_client_connector_service",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = (
            client_connector_services_service.CreateClientConnectorServiceRequest.pb(
                client_connector_services_service.CreateClientConnectorServiceRequest()
            )
        )
        transcode.return_value = {
...
def test_create_client_connector_service_rest_bad_request(
    transport: str = "rest",
    request_type=client_connector_services_service.CreateClientConnectorServiceRequest,
):
    client = ClientConnectorServicesServiceClient(
...
def test_update_client_connector_service_rest_required_fields(
    request_type=client_connector_services_service.UpdateClientConnectorServiceRequest,
):
    transport_class = transports.ClientConnectorServicesServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).update_client_connector_service._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ClientConnectorServicesServiceRestInterceptor,
        "post_update_client_connector_service",
    ) as post, mock.patch.object(
        transports.ClientConnectorServicesServiceRestInterceptor,
        "pre_update_client_connector_service",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = (
            client_connector_services_service.UpdateClientConnectorServiceRequest.pb(
                client_connector_services_service.UpdateClientConnectorServiceRequest()
            )
        )
        transcode.return_value = {
...
def test_update_client_connector_service_rest_bad_request(
    transport: str = "rest",
    request_type=client_connector_services_service.UpdateClientConnectorServiceRequest,
):
    client = ClientConnectorServicesServiceClient(
...
def test_update_client_connector_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{client_connector_service.name=projects/*/locations/*/clientConnectorServices/*}"
            % client.transport._host,
            args[1],
        )
...
def test_delete_client_connector_service_rest_required_fields(
    request_type=client_connector_services_service.DeleteClientConnectorServiceRequest,
):
    transport_class = transports.ClientConnectorServicesServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_client_connector_service._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_client_connector_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        post.assert_not_called()
        pb_message = (
            client_connector_services_service.DeleteClientConnectorServiceRequest.pb(
                client_connector_services_service.DeleteClientConnectorServiceRequest()
            )
        )
        transcode.return_value = {
...
def test_credentials_transport_error():
    ...
    transport = transports.ClientConnectorServicesServiceGrpcTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = ClientConnectorServicesServiceClient(
...
def test_transport_get_channel():
    ...
    transport = transports.ClientConnectorServicesServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_client_connector_services_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.beyondcorp_clientconnectorservices_v1.services.client_connector_services_service.transports.ClientConnectorServicesServiceTransport.__init__"
    ) as Transport:
...
def test_client_connector_services_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.beyondcorp_clientconnectorservices_v1.services.client_connector_services_service.transports.ClientConnectorServicesServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_client_connector_services_service_transport_auth_gdch_credentials(
    transport_class,
):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.ClientConnectorServicesServiceGrpcTransport, grpc_helpers),
        (
            transports.ClientConnectorServicesServiceGrpcAsyncIOTransport,
            grpc_helpers_async,
        ),
...
def test_client_connector_services_service_transport_create_channel(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_client_connector_services_service_grpc_transport_client_cert_source_for_mtls(
    transport_class,
):
...
def test_client_connector_services_service_host_with_port(transport_name):
    client = ClientConnectorServicesServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(
            api_endpoint="beyondcorp.googleapis.com:8000"
        ),
        transport=transport_name,
    )
    assert client.transport._host == (
        "beyondcorp.googleapis.com:8000"
        if transport_name in ["grpc", "grpc_asyncio"]
        else "https://beyondcorp.googleapis.com:8000"
    )
...
def test_client_connector_services_service_client_transport_session_collision(
    transport_name,
):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = ClientConnectorServicesServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = ClientConnectorServicesServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_client_connector_service_path():
    ...
    expected = "projects/{project}/locations/{location}/clientConnectorServices/{client_connector_service}".format(
        project=project,
        location=location,
        client_connector_service=client_connector_service,
    )
    actual = ClientConnectorServicesServiceClient.client_connector_service_path(
...
def test_parse_client_connector_service_path():
    expected = {
        "project": "octopus",
        "location": "oyster",
        "client_connector_service": "nudibranch",
    }
    path = ClientConnectorServicesServiceClient.client_connector_service_path(
        **expected
    )

    # Check that the path construction is reversible.
    actual = ClientConnectorServicesServiceClient.parse_client_connector_service_path(
        path
    )
    assert expected == actual
...
def test_common_billing_account_path():
    ...
    actual = ClientConnectorServicesServiceClient.common_billing_account_path(
        billing_account
    )
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    # Check that the path construction is reversible.
    actual = ClientConnectorServicesServiceClient.parse_common_billing_account_path(
        path
    )
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.ClientConnectorServicesServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = ClientConnectorServicesServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
def test_get_iam_policy_rest_bad_request(
    ...
    request = request_type()
    request = json_format.ParseDict(
        {"resource": "projects/sample1/locations/sample2/appConnections/sample3"},
        request,
    )
